...
def file_chunk_stems(file_list, level=2):
    ## Extract filenames based on the hierarchical relationship of data storage. level=1 means files are directly under the folder, 
    # level=2 means there will be subfolders. Currently the maximum is set to 2 levels
    stems = []
