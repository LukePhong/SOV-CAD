...
parser.add_argument('--data_root', type=str, default="data/SolidWorksNew/json", help="json file dir")
parser.add_argument('--record_file', type=str,  default="data/SolidWorksNew/train_valid_test_split.json", help="filepath to store the filename of DATA_ROOT")
parser.add_argument('--output', type=str, default="data/SolidWorksNew/json2vec", help="dir to save the vector")
