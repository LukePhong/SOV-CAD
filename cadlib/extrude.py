...
class CADSequence(object):
    ...
    def from_dict(all_stat):
        ...
        for item in all_stat["sequence"]:
            if item["type"] == "Extrusion" or item["type"] == "ExtrudeFeature":
        ...
        max_point = 1000 * np.array([bbox_info["max_point"]["x"], bbox_info["max_point"]["y"], bbox_info["max_point"]["z"]])    # there are * 1000 originally
    ...
    def to_vector(self, max_n_ext=10, max_n_loops=100, max_len_loop=100, max_total_len=10000, pad=False):
